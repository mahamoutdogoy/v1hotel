...
/*,noOfRoom='$rooms'*/
	$sql="UPDATE reservation SET property_id='$hotel_id' ,room_id='$room_id',inventory_id='$room_sub_id',guestName='$guest_name',email='$email',phoneNo='$phone',noOfAdults='$adults',noOfChildren='$children',price	='$price',total='$total',nights='$nights',channel='$channel',status='$status' ";
...
else if(isset($_POST['credit']))
{
  ...
  if($folio==$pending_bills && $temp[0]==1)
  {
...
else if(isset($_POST['generate_invoice']))
{
	...
	mysqli_query($con,$sql1) or die(mysqli_error($con));
	header('location:http://localhost/pms/print_invoice.php');
