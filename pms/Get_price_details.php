...
$query12=mysqli_query($con,"select * from rooms_tariff where  property_id='".$_SESSION['user']['hotelid']."' and room_id=$_GET[roomid] and meal_plan='$_GET[mealplan]'") or die(mysqli_error($con));
...
$query12=mysqli_query($con,"select * from rooms_tax where  property_id='".$_SESSION['user']['hotelid']."' and room_id=$_GET[roomid] and meal_plan='$_GET[mealplan]'") or die(mysqli_error($con));
if(mysqli_num_rows($query12)>0)
{
