...
<script>
    ...
    $(document).ready(function(){
			...
			$('#inventory').keyup(function(){
				...
				for(j=0;j<i;j++)
				{
				$('#s').append('<input style="width:50px" type="text" class="form-control" required="true" id="room_sub_id" name="room_sub_id[]">');
				}
	...
	<div id="div1">
		...
		<table align="center" id="t1"  cellpadding="15px"  cellspacing="10" style="opacity: 0.8;">
			...
			<tr>
				...
				<td><select name="property_id" id="property" class=" form-control" required style="width:215px;height: 35px;text-align: center;" >
			...
			<tr>
				<td>Room ID</td>
				<td><div id="room_div"><input type="text" readonly name="room_id" class=" form-control" style="width:215px">
				</div>
			...
			<tr>
				<td>Room Name</td>
				<td><input type="text" id="room_name" class="form-control" required name="room_name" style="width:215px" value="<?php if(isset($_POST['room_name'])){echo htmlentities($_POST['room_name']);} ?>"></td>
			</tr>
			<tr>
				<td>Description</td>
				<td><textarea rows="5" placeholder="Max 500 words" class="form-control" cols="55" name="description" maxlength="500" required><?php if(isset($_POST['description'])){echo htmlentities($_POST['description']);} ?></textarea></td>
			</tr>
			<tr>
				<td>Min. Occupancy</td>
				<td><input type="number" name="min_occupancy" class="form-control" required style="width:215px" value="1" required></td>
			</tr>
			<tr>
				<td>Max. Occupancy</td>
				<td><input type="number" placeholder="Adult" class="form-control" required name="max_occupancy_adult" style="width:215px"  value="<?php if(isset($_POST['max_occupancy_adult'])){echo htmlentities($_POST['max_occupancy_adult']);} ?>" >
					<input type="number" name="max_occupancy_child" class="form-control"  required placeholder="Children" style="width:215px"  value="<?php if(isset($_POST['max_occupancy_child'])){echo htmlentities($_POST['max_occupancy_child']);} ?>" >
				</td>
			</tr>
			<tr>
				<td>Tariff As</td>
			...
			<tr  >
				<td>Inventory</td>
				<td><input type="text" name="inventory" id="inventory" class="form-control" autocomplete="off" required style="width:215px"  value="<?php if(isset($_POST['inventory'])){echo htmlentities($_POST['inventory']);} ?>">
				</td>
			</tr>
			<tr  id="sub_row" >
				<td>Room No.</td>
			...
			<tr>
				<td>Status</td>
				<td>
					<select name="status" class="form-control" required style="width:215px;height: 35px;text-align: center;" >
						<option selected disabled>--Select--</option>
			...
			<tr>
				<td align="center" colspan="2"><input type="submit" name="save" value="  Save  " class="btn btn-success" onclick="return test_room_id();">&emsp;
...
function test_room_id() {
  ...
  var numFlds = document.myform.room_sub_id.length;
  for (var x=0; x<numFlds; x++) {
    for (var y=x+1; y<numFlds; y++) {
      if (document.myform.room_sub_id[x].value == document.myform.room_sub_id[y].value) {
        alert('Do not allow same room sub number');
        return false;
      }
    }
  }
