...
<head>
	...
	<title>Mytravaly | Apply for Leave</title>
					...
					<form action="" method="post">
						...
						<div class="form-inline" style="margin: 20px 0 0 0;">
							...
							<select name="leavecat" id="" style="margin-left: 20px; height: 40px; width: 225px;" required>
								...
								<?php
									$adminId = getAdminId($con, $loginid);
									$sel_sql = "SELECT catid,catname FROM leave_category WHERE cuserid = '$adminId'";
...
<?php
  if(isset($_POST['createApp'])){
    ...
    $ins_sql = "INSERT INTO leave_application (appuserid, appdesc, appcatid, appdate, appstatus) VALUES ('$loginid', '$leavedesc', '$leavecat', '$newformat', '$status')";//sessionnnnn...
