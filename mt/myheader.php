 ...
 <nav class="navbar navbar-expand-md " >
     <div class="container-fluid">
      <?php if($_SESSION['user']['role'] == 'admin' || $_SESSION['user']['role'] == 'Admin'):?>
         <a href="http://localhost/v1hotel/mytravalyAdmin/mt.php" class="navbar-brand text-uppercase">
         <!-- <h1 class="hh">Admin Dashboard</h1> -->
         <img src="../mytravalyAdmin/images/Logo_mytravaly.png" alt="Logo" width="100" height="100" style="border-radius: 50%;" ></a>
       <?php else:?>
          <a href="http://localhost/v1hotel/usermgt/attendance.php" class="navbar-brand text-uppercase">
         <!-- <h1 class="hh">Admin Dashboard</h1> -->
         <img src="../mytravalyAdmin/images/Logo_mytravaly.png" alt="Logo" width="100" height="100" style="border-radius: 50%;"></a>
     <?php endif;?>
            ...
            <li class="nav-item mr-4">
                ...
                <li class="nav-item mr-4">
                    ...
                    <li class="nav-item mr-5">
                        ...
                        <a href="#" class="nav-link">
                          <img src='../mytravalyAdmin/<?php echo $image_src; ?>' style='width:50px;height:50px' alt=person class='img-fluid rounded-circle img-thumbnail mr-3'/>
<!-- 
