 ...
 <nav class="navbar navbar-expand-md " >
     <div class="container-fluid">
      <?php if ( ucwords($_SESSION['user']['role']) == 'Admin' ||  ucwords($_SESSION['user']['role']) == 'Superadmin'):?>
         <a href="/v1hotel/mytravalyAdmin/mt.php" class="navbar-brand text-uppercase">
       ...
       <?php else:?>
          <a href="/v1hotel/usermgt/attendance.php" class="navbar-brand text-uppercase">
         <!-- <h1 class="hh">Admin Dashboard</h1> -->
         <img src="../mytravalyAdmin/images/Logo_mytravaly.png" alt="Logo" width="100" height="100" style="border-radius: 50%;"></a>
     <?php endif;?>
       ...
       <div class="collapse navbar-collapse justify-content-end" id="myNavbar">
         ...
         <ul class="navbar-nav links d-md-none">
             <li class="nav-item">
                 <a href="/mytravaly/v1/mytravalyAdmin/mt.php" class="nav-link">
