<?php //include "../usermgt/adminOnly.php";?>
<link rel="stylesheet" type="text/css" href="/v1hotel/mytravalyAdmin/main.css">
 <!------------ side bar ---------------->
    ...
    <div class="row">
        <!------------ sidebar ------------->
         <nav class="col-md-3 col-lg-2 d-none d-md-block sidebar right-padding max-viewport">
            ...
            <a href="/v1hotel/mytravalyAdmin/profile.php" class="navbar-brand py-3">
 ...
 -->
       ...
       <!--     <i>(<?php// echo $_SESSION['user']['role'];?>) </i> -->
         ...
         <ul class="navbar-nav flex-column">
            <li class="nav-item">
                <a href="/v1hotel/mytravalyAdmin/mt.php" class="nav-link">
           ...
           <!--  <li class="nav-item">
               ...
               <li class="nav-item">
                       <a href="/v1hotel/mytravalycrm/index.php" class="nav-link">
                           <i class="fa fa-envelope " style="color:#E01A4F;"></i>   
                           &nbsp;&nbsp;CRM         
                          </a>
                   </li>
                   <li class="nav-item">
                           <a href="/v1hotel/property/rooms_dashboard_new.php" class="nav-link">
                               <i class="fa fa-building" style="color:rgba(194, 36, 133, 0.747)"></i>   
                               &nbsp;&nbsp;Property      
                              </a>
                       </li>
                       <li class="nav-item">
                               <a href="/v1hotel/pms/index.php" class="nav-link">
        ...
        <ul class="navbar-nav flex-column">
           ...
           <!--  <li class="nav-items">
            ...
            <li class="nav-items">
                   <a href="/v1hotel/hotelAccounts/index.php" class="nav-link">
               ...
               <!-- <li class="nav-item">
                  ...
                  <!--  <li class="nav-item">
                       ...
                       <li class="nav-item">
                               <a href="/v1hotel/market/index.php" class="nav-link">
...
<!-- 
 ...
 -->
                           ...
                           <li class="nav-item">
                               <a href="/v1hotel/mytravalyAdmin/profile.php" class="nav-link">
                                   <i class="fa fa-shopping-bag " style="color:#07775f"></i>   
                                   &nbsp;&nbsp;Setting       
                                  </a>
                           </li>
...
<!-- 
 ...
 -->
                           ...
                           <li class="nav-item">
                                <a href="/v1hotel/usermgt/user_main1.php" class="nav-link">
