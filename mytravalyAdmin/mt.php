                ...
                <div class="card-body">
                    ...
                    <div class="flex d-flex justify-content-between">
                        ...
                        <div class="side-text align-self-center">
                            ...
                            <h3><?php echo number_format($totalbooking); ?></h3>
                                        <h5>total booking</h5>
                ...
                <div class="card card-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="flex d-flex justify-content-between">
                            ...
                            <div class="side-text align-self-center">
                                <h3><?php echo number_format($checkin); ?></h3>
                            ...
                            <div class="card-body">
                                ...
                                <div class="flex d-flex justify-content-between">
                                    ...
                                    <div class="side-text align-self-center">
                                        ...
                                        <h3><?php echo number_format($checkout); ?></h3>
                                        <h5>Today check out</h5>
                        ...
                        <div class="card card-5">
                            ...
                            <div class="card-body">
                                ...
                                <div class="flex d-flex justify-content-between">
                                    ...
                                    <div class="side-text align-self-center">
                                        <h3><?php echo number_format($totalleads) ;?></h3>
                                        <h5>total leads</h5>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="flex d-flex justify-content-between">
                                    ...
                                    <div class="side-text align-self-center">
                                        ...
                                        <h3><?php echo number_format($dep) ?></h3>
                            <h5>Departments</h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card card-7">
                            ...
                            <div class="card-body">
                                ...
                                <div class="flex d-flex justify-content-between">
                                    ...
                                    <div class="side-text align-self-center">
                                    <h4><?php echo number_format($vusers); ?></h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="flex d-flex justify-content-between">
                                    ...
                                    <div class="side-text align-self-center">
                                        ...
                                        <!-- <h3><?php echo number_format($notcompleted); ?></h3>
