...
<nav  aria-label="breadcrumb" style=color:white;>
  ...
  <ol class="breadcrumb "  style="background-color:#ff6f56; margin-right:30px; margin-left: 30px"; >
   <!--  <center><li class="breadcrumb-item active" aria-current="page" ><h3>User Profile</h3></li></center> -->
    <?php if ( ucwords($_SESSION['user']['role']) == 'Admin' ||  ucwords($_SESSION['user']['role']) == 'Superadmin'):?>
         <a href="mt.php" class="fa fa-arrow-left" style="color:white; text-decoration: none;">BACK</a>
       <?php else:?>
            <a href="../usermgt/attendance.php" class="fa fa-arrow-left" style="color:white; text-decoration: none;">BACK</a>
     <?php endif;?>
    ...
    <div class="col-md-4 ">      
        <div class="portlet light profile-sidebar-portlet bordered">
            <div class="profile-userpic">
               <center> <img src='<?php echo $image_src; ?>' style='width:200px;height:450px; ce' alt=person class='img-fluid rounded-circle img-thumbnail mr-3'/></center>
...
<?php
    if (isset($_POST['update'])){
        ...
        $pw_sql = "SELECT password from users WHERE userid=".$_SESSION['user']['userid'];
        ...
        if ($newpass!==$confpass) {
            ...
            if(password_verify($curpass, $hashedPass)) {
                ...
                $pw_sql = "UPDATE users SET password='$newpass' WHERE userid=".$_SESSION['user']['userid'];
