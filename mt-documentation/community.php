...
<body>
	...
	<h1 id="docEntittles" class="text-center jumbotron">Community</h1>
	...
	<div class="container bot-nav">
		<div class="row">
			<div class="col-xl-6 col-lg-7 col-md-8 col-sm-10 col-11 mx-auto">
				<a href="help-center.php"><i class="fa fa-chevron-left"></i> Help Center</a>
				<span class="float-right"><a href="faq.php">FAQs <i class="fa fa-chevron-right"></i></a></span>
			</div>
		</div>
	</div> 
