...
<body>
	...
	<h1 id="docEntittles" class="text-center jumbotron">Blog</h1>
	...
	<div class="container bot-nav">
		<div class="row">
			<div class="col-xl-6 col-lg-7 col-md-8 col-sm-10 col-11 mx-auto">
				<a href="tech@mytravaly.php"><i class="fa fa-chevron-left"></i> Tech@MyTravaly</a>
				<span class="float-right"><a href="press-room.php">Press Room <i class="fa fa-chevron-right"></i></a></span>
			</div>
		</div>
	</div> 
