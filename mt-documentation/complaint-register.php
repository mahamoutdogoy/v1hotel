...
<body>
	...
	<h1 id="docEntittles" class="text-center jumbotron">Complaint Register</h1>
	...
	<div class="text-justify mb-5 container">
		<div class="row">
			<div class="col-xl-6 col-lg-7 col-md-8 col-sm-10 col-11 mx-auto">
				<p>
					For any complaints pertaining to our site, please contact <a href="mailto:complaint@mytravaly.com">complaint@mytravaly.com</a>. Our support team will reach out to you within 24 hours. We’ll try our best to solve your problem within a reasonable time frame.
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container bot-nav">
		<div class="row">
			<div class="col-xl-6 col-lg-7 col-md-8 col-sm-10 col-11 mx-auto">
				<a href="faq.php"><i class="fa fa-chevron-left"></i> FAQs</a>
				<span class="float-right"><a href="knowledge-base.php">Knowledge Base <i class="fa fa-chevron-right"></i></a></span>
			</div>
		</div>
	</div>
