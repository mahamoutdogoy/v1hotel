...
<body>
	...
	<h1 id="docEntittles" class="text-center jumbotron">FAQs</h1>
	...
	<div class="container bot-nav">
		<div class="row">
			<div class="col-xl-6 col-lg-7 col-md-8 col-sm-10 col-11 mx-auto">
				<a href="community.php"><i class="fa fa-chevron-left"></i> Community</a>
				<span class="float-right"><a href="complaint-register.php">Complaint Register <i class="fa fa-chevron-right"></i></a></span>
			</div>
		</div>
	</div>
