...
<body>
	...
	<h1 id="docEntittles" class="text-center jumbotron">Careers</h1>
	...
	<div class="text-justify mb-5 container">
		<div class="row">
			<div class="col-xl-6 col-lg-7 col-md-8 col-sm-10 col-11 mx-auto">
				<p>
					Reach out to us at <a href="mailto:career@mytravaly.com">career@mytravaly.com</a> if you're interested in working with us.
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container bot-nav">
		<div class="row">
			<div class="col-xl-6 col-lg-7 col-md-8 col-sm-10 col-11 mx-auto">
				<a href="work-culture.php"><i class="fa fa-chevron-left"></i> Work Culture</a>
				<span class="float-right"><a href="investor-relation.php">Investor Relations <i class="fa fa-chevron-right"></i></a></span>
			</div>
		</div>
	</div> 
