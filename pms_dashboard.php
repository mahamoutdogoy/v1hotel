...
<body class="holidaysm">
	...
	<div id="nav">
		...
		?>
			...
			<a href="#" id="" data-toggle="modal" data-target="#myModal" class="button">Today's Arival</a>	
			<a href="#" id="" data-toggle="modal" data-target="#myModal1" class="button">Today's bookings</a>	
			<a href="#" id="" data-toggle="modal" data-target="#myModal2" class="button">Today's Departure</a>	
			<br>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-header"> 
          <h4 class="modal-title">   <center> Todys Check in</center>   </h4>
...
<?php
    $query = "SELECT reservationId, guestName, email, phoneNo FROM reservation WHERE check_in >= CURDATE()
...
<?php
    $query = "SELECT reservationId, guestName, email, phoneNo FROM reservation WHERE DATE(reservationDate)=DATE(NOW())";
    $result = mysqli_query($db, $query);
...
<?php
    $query = "SELECT reservationId, guestName, email, phoneNo FROM reservation WHERE check_out >= CURDATE()
