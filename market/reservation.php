...
<div class="col-sm-8 " style="border: 1px;border-radius: 20px;margin-bottom: 0px ">
	<h5 style="color: #ff6f56;">Guests Details</h5>
	<p>Log into your account to use wallet amount & for faster booking details</p>
	<form method="POST" style="border-bottom-right-radius: 10px;border-bottom: 10px solid #ff6f56;">
		<div class=" row ">
			<p class=" col-sm-6">
		...
		<div class=" row">
			...
			<p class=" col-sm-6 " >
				<strong>Email*</strong>
				<input type="email" name="email" id="email1" class=" w-100" required="" value="<?php if(isset($_POST['gender'])){
					echo $_SESSION['email'];
				} ?>">
			</p>
		...
		<div class="row">
			...
			<div class="col-sm-4">
				...
				<input type="radio" name="gender" value="mal" onchange="this.form.submit()">Mal&nbsp;
		...
		<div class="col-sm-4  pt-0 pb-0 mb-4" style="border-radius:50px;float: right;background-color: #ff6f56;">
