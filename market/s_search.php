    ...
    <section class="mb-5">
      <div class="container">
        <ul class="list-inline pr-3">
          ...
          <li class="list-inline-item"><a style="color: #ff6f56;" class="social-icon " target="_blank" href="#"><i class="fas fa-arrow-circle-right"></i></a></li>
          <li class="list-inline-item"><a style="color: #ff6f56;" class="social-icon " target="_blank" href="#">From <i class="fas fa-arrow-circle-right"></i></a></li>
          <li class="list-inline-item"><a style="color: #ff6f56;" class="social-icon " >To <i class="fas fa-arrow-circle-right"></i></a></li>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <input type="date" id="checkin" class="form-control" name="checkin" placeholder="check in date" min="<?php echo date('Y-m-d'); ?>">
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <label for=""><b>Check Out</b></label>
                    <input type="date" id="checkout" class="form-control" name="checkout" placeholder="check out date" onclick="return setMinDate();">
                  </div>
                </div>
              </div>
            </div>
...
if(isset($_POST['filter_search'])){
  if(!empty($_POST['checked_list'])){
    foreach($_POST['checked_list'] as $all_type) {
      ...
      $query = "SELECT * FROM propertydetails WHERE propertytype='$all_type' AND property_price>='$_POST[filter_price]' AND property_price<=3000 AND keyword='$keyword'";
    }elseif($_POST['filter_price']==3000){
      $query = "SELECT * FROM propertydetails WHERE propertytype='$all_type' AND property_price>='$_POST[filter_price]' AND property_price<=5000 AND keyword='$keyword'";
    }elseif($_POST['filter_price']==5000){
     $query = "SELECT * FROM propertydetails WHERE propertytype='$all_type' AND property_price>='$_POST[filter_price]' AND property_price<=8000 AND keyword='$keyword'";
    }elseif($_POST['filter_price']==8000){
      $query = "SELECT * FROM propertydetails WHERE propertytype='$all_type' AND property_price>='$_POST[filter_price]' AND property_price<=10000 AND keyword='$keyword'";
    }elseif($_POST['filter_price']==10000){
      $query = "SELECT * FROM propertydetails WHERE propertytype='$all_type' AND property_price>='$_POST[filter_price]' AND property_price<=12000 AND keyword='$keyword'";
    }else{
      $query = "SELECT * FROM propertydetails WHERE propertytype='$all_type' AND property_price>='$_POST[filter_price]' AND keyword='$keyword'";
    }
    ...
    if($_POST['filter_price']==1000){
      $query = "SELECT * FROM propertydetails WHERE  property_price>='$_POST[filter_price]' AND property_price<=3000 AND keyword='$keyword'";
    }elseif($_POST['filter_price']==3000){
      $query = "SELECT * FROM propertydetails WHERE  property_price>='$_POST[filter_price]' AND property_price<=5000 AND keyword='$keyword'";
    }elseif($_POST['filter_price']==5000){
     $query = "SELECT * FROM propertydetails WHERE  property_price>='$_POST[filter_price]' AND property_price<=8000 AND keyword='$keyword'";
    }elseif($_POST['filter_price']==8000){
      $query = "SELECT * FROM propertydetails WHERE  property_price>='$_POST[filter_price]' AND property_price<=10000 AND keyword='$keyword'";
    }elseif($_POST['filter_price']==10000){
      $query = "SELECT * FROM propertydetails WHERE  property_price>='$_POST[filter_price]' AND property_price<=12000 AND keyword='$keyword'";
    }else{
      $query = "SELECT * FROM propertydetails WHERE  property_price>='$_POST[filter_price]' AND keyword='$keyword'";
    }
 ...
 ?>
        ...
        if($sorting1 OR $sorting2 OR $sorting3 OR $sorting4){
          if($sorting1){
            $query = "SELECT * FROM propertydetails WHERE keyword='$keyword' ORDER BY property_name ";
          }elseif ($sorting2) {
           $query = "SELECT * FROM propertydetails WHERE keyword='$keyword' ORDER BY rating DESC ";
         }elseif($sorting3){
           $query = "SELECT * FROM propertydetails WHERE keyword='$keyword' ORDER BY property_price ";
         }
         else{
           $query = "SELECT * FROM propertydetails WHERE keyword='$keyword' ORDER BY star DESC ";
         }
      ...
      if($wedding OR $world OR $city OR $night OR $culture OR $food){
        if($wedding){
          ...
          $query = "SELECT * FROM propertydetails WHERE keyword='citylife'";
        }elseif ($night) {
          $query = "SELECT * FROM propertydetails WHERE keyword='nightlife'";
        }elseif ($culture) {
